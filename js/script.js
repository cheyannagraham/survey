...
const addEvents = (form_values) => {
    ...
    form.addEventListener('change', (e) => {
        ...
        // const name =
        // document.getElementsByName(e.target.name).setAttribute('value', e.target.value);
        // save_form_content(form_values);
        save_form_content(e);
    });
}
...
const get_forms = () => {
    ...
    return Promise.all([get_data(0), get_data(1), get_data(2), get_data(3), get_data(4)])
    .then(forms => forms);
}
...
const save_form_content = (e) => {
    ...
    current_form = document.querySelector('fieldset[data-current]').getAttribute('data-current');
